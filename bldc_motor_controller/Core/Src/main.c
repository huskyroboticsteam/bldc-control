...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, enable_pin_Pin|clk_select_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : enable_pin_Pin clk_select_Pin */
  GPIO_InitStruct.Pin = enable_pin_Pin|clk_select_Pin;
